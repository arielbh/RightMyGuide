...
namespace RightMyGuide.WindowsPhone
{
    public partial class App : Application
    {
        ...
        private void InitializePhoneApplication()
        {
            ...
            IMdbServiceClient = new IMdbServiceClient(new BasicHttpBinding(BasicHttpSecurityMode.None), new EndpointAddress("http://demoepisodeservice.cloudapp.net/IMdbService.svc"));
